    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-sm-12 mb-4 mb-md-0">
                ...
                <p>The IT Factory is the common direction Electronics / ICT - Applied Informatics of Thomas More
                    University College Geel.</p>
            </div>
            <!--Grid column-->
            ...
            <div class="col-lg-2 col-sm-12 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li>
                        <a href="../projecten" class="text-dark">Projects</a>
                    </li>
                    <li>
...
{{--        <a href="./login" class="text-dark float-right">Admin</a>--}}

<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm sticky-top">
    <div class="container">
        ...
        <a class="navbar-brand" href="/">#ITFACTORY</a>
        ...
        <div class="collapse navbar-collapse" id="collapsNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#!" data-toggle="dropdown">Dagopleiding</a>
                    <div class="dropdown-menu dropdown-menu-right animate slideIn">
                        {{--                        <a class="dropdown-item" href="../opleidingen/applicationDevelopment">Application--}}
                        {{--                            Development</a>--}}
                        {{--                        <a class="dropdown-item" href="../opleidingen/artificialIntelligence">Artificial--}}
                        {{--                            Intelligence</a>--}}
                        {{--                        <a class="dropdown-item" href="../opleidingen/cloudCyberSecurity">Cloud & Cyber Security</a>--}}
                ...
                {{--                <li class="nav-item">--}}
                {{--                    <a class="nav-link" href="../studiewijzer">Studiewijzer</a>--}}
                {{--                </li>--}}
                {{--                <li class="nav-item">--}}

...
<head>
    ...
    <title>@yield('title', 'IT Factory | Werken en studeren')</title>
</head>
<body>
{{--  Navigation  --}}
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 content">
                ...
                <p class="font-italic">De IT Factory is de gemeenschappelijke richting Elektronica/ICT – Toegepaste Informatica van Thomas More hogeschool campus Geel.
                    <br>Wij bieden aan:</p>
                <ul>
                    <li><a style="color:black; font-weight:bold;" href="./wes/app"><i class="far fa-check-circle"></i> Application Development:</a>
                        when programming rocks your world!
                    </li>
                    <li><a style="color:black; font-weight:bold;" href="./wes/ccs"><i class="far fa-check-circle"></i> Cloud & Cyber Security:</a>
